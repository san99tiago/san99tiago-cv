...
const ExperienceAWSCommunityBuilder = () => (
    <Layout title="AWS Community Builder">
        <Container>
            ...
            <P>
            I am proud to have been chosen as an official AWS Community Builder, recognizing my leadership and technical expertise. My selection was based on my active contributions to the open-source community on GitHub and my growing YouTube channel.
            </P>
            <Divider my={5} />
            ...
            <Section delay={0.1}>
                ...
                <ExperienceSection>
                    ...
                    The AWS Community Builders program is geared towards AWS technical enthusiasts and emerging thought leaders who are passionate about sharing knowledge and connecting with the AWS technical community.
                </ExperienceSection>
                <ExperienceSection>
                    <BadgeStyle><BadgeGreen>Program</BadgeGreen></BadgeStyle>
                    <Link
                        href="https://aws.amazon.com/developer/community/community-builders/"
                        target='_blank'
                        >
                        Official AWS Community Builders Page<ExternalLinkIcon mx="2px" />
                    </Link>
                </ExperienceSection>
                <ExperienceSection>
                    <BadgeStyle><BadgeYellow>Post</BadgeYellow></BadgeStyle>
                    <Link
                        href="https://www.linkedin.com/posts/san99tiago_awscommunity-awscommunitybuilders-aws-activity-7040483263907274752-LACZ"
                        target='_blank'
                        >
                        LinkedIn Post Explaining AWS CB Program<ExternalLinkIcon mx="2px" />
                    </Link>
                </ExperienceSection>
            </Section>
